...
const Footer = () => {
  return (
<footer className="bg-white dark:bg-neutral-900 pt-16 pb-8 px-4 md:px-8">
  <div className="max-w-7xl mx-auto">
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-12 gap-x-6 sm:gap-x-8">
      <div className="lg:flex lg:items-center">
      
        <img src="/pixfixh.svg" alt />
      </div>
      <div className="lg:flex lg:items-center">
        <ul className="flex flex-wrap gap-6">
          <li>
            <a href="#" className="flex items-center bg-slate-200 dark:bg-neutral-800 w-8 h-8 p-2 rounded-full focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500" aria-label="Facebook">
              <svg xmlns="http://www.w3.org/2000/svg" className="size-full fill-slate-600 dark:fill-slate-50" viewBox="0 0 155.139 155.139" aria-hidden="true">
          ...
          <li>
            <a href="#" className="flex items-center bg-slate-200 dark:bg-neutral-800 w-8 h-8 p-2 rounded-full focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500" aria-label="LinkedIn">
          ...
          <li>
            <a href="#" className="flex items-center bg-slate-200 dark:bg-neutral-800 w-8 h-8 p-2 rounded-full focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500" aria-label="X">
          ...
          <li>
            <a href="#" className="flex items-center bg-slate-200 dark:bg-neutral-800 w-8 h-8 p-2 rounded-full focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500" aria-label="Github">
              <svg xmlns="http://www.w3.org/2000/svg" className="size-full fill-slate-600 dark:fill-slate-50" viewBox="0 0 438.549 438.549" aria-hidden="true">
      ...
      <div>
        <h3 className="text-slate-900 dark:text-slate-50 font-semibold text-sm mb-6">Useful links</h3>
        <ul className="space-y-4 text-slate-600 dark:text-slate-400 text-sm font-normal">
          <li>
            <a href="#" className="hover:text-slate-900 dark:hover:text-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded transition-all">Featured</a>
          </li>
          <li>
            <a href="#" className="hover:text-slate-900 dark:hover:text-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded transition-all">New
              Arrivals</a>
          </li>
          <li>
            <a href="#" className="hover:text-slate-900 dark:hover:text-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded transition-all">New
      ...
      <div>
        <h3 className="text-slate-900 dark:text-slate-50 font-semibold text-sm mb-6">Information</h3>
        <ul className="space-y-4 text-slate-600 dark:text-slate-400 text-sm font-normal">
          <li>
            <a href="#" className="hover:text-slate-900 dark:hover:text-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded transition-all">About
              Us</a>
          </li>
          <li>
            <a href="#" className="hover:text-slate-900 dark:hover:text-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded transition-all">Terms
              &amp; Conditions</a>
          </li>
          <li>
            <a href="#" className="hover:text-slate-900 dark:hover:text-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded transition-all">Privacy
              Policy</a>
          </li>
          <li>
            <a href="#" className="hover:text-slate-900 dark:hover:text-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded transition-all">Sale</a>
          </li>
          <li>
            <a href="#" className="hover:text-slate-900 dark:hover:text-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded transition-all">Documentation</a>
          </li>
        </ul>
      </div>
    </div>
    <p className="text-slate-600 dark:text-slate-400 text-sm mt-8">© pixfix All rights reserved.
    </p>
  </div>
</footer>
